...
def main():
    ...
    Retrieves the user's plain text emails and specific HTML content from the past day in the Primary category 
    ...
    try:
        ...
        print("Emails received in the past day in the Primary category:")
            ...
            for msg in messages:
                ...
                if html_content:
                    ...
                    if specific_content:
                        ...
                        print("No specific HTML content found.")
                        file.write("No specific HTML content found.\n")
                else:
                    print("No HTML content found.")
                    file.write("No HTML content found.\n")
